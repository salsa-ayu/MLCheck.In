...
class VRAE(BaseEstimator, nn.Module):
    ...
    def _train(self, train_loader):
        ...
        for i, (input_seq, _) in enumerate(train_loader):
            ...
            # Forward pass
            output_seq, z, mu, logvar = self.model(input_seq)
            ...
            print('Batch: %s, Recon Loss: %.4f, KL Loss: %.4f' % (i, recon_loss.item(), kl_loss.item()))
